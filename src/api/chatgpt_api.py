...
import traceback
import signal
from helpers import PrefixDict, shutdown, get_exo_images_dir
...
from download.new_shard_download import delete_model
import tempfile
...
def generate_completion(
    ...
    completion = {
        ...
        "system_fingerprint": f"tela_hypergrid_{VERSION}",
        "choices": [
            {
                "index": 0,
