...
from download.shard_download import ShardDownloader, NoopShardDownloader
from download.download_progress import RepoProgressEvent
from download.new_shard_download import (
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Inference engine to use (torch, mlx, tinygrad, or dummy)",
)
parser.add_argument(
